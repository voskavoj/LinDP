...
from source.files import load_with_pickle
from source.plotting import plot_average_step
...
## start dropping by variation
    ...
    cutoff_rms = sorted(rms_values, reverse=True)[6 - 1]
    ...
    plot_average_step(kept_steps, average_step)
...
if __name__ == "__main__":
    ...
    for name in ["Z_an_sk_O_pred_6D.tsv"]:
        d = load_with_pickle("data/", name)
        find_average_step(d)
